...
```powershell
gvm-cli tls --hostname 172.18.100.10 --port 9390 `
  --gmp-username admin --gmp-password "TU_PASSWORD" `
...
- El firewall entre tu equipo y Greenbone debe permitir `172.18.100.80:9390`.
